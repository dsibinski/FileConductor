    ...
    internal class FileConductorService
    {
        public bool Start()
        {
            ...
            var operationProp = new OperationProperties()
            {
                ...
                NotificationSettings = new SpecifiedTimeNotification(new int[] {0,1,2,3,4,5,6}, new TimeSpan(07,29,0)),
            ...
            //    NotificationSettings = new SpecifiedTimeNotification(new int[] { 0, 1, 2, 3, 4, 5, 6 }, new TimeSpan(16,31, 0)),
